...
const Collaborate = () => {
  return (
    <>
      <Head>
        <title>Colaborar | Psievidencia</title>
      </Head>
        ...
        <div className="text-xl leading-normal mt-6">
          ...
          <ol>
            ...
            <li className="mb-6">
              ...
              <p>
                Como sabrás, este sitio aún no cuenta con las mejores prácticas
                en términos de UX/UI, ni el mejor logo, etc. Si te gustaría
                aportar desde este lado, ¡sos{" "}
                <Link href="/contact">
            ...
            <li className="mb-6">
              ...
              <p>
                ...
                haciendo entre todes. (En realidad, yo prefiero una pizza, pero
                un Cafecito viene súper bien).
              </p>
            </li>
            <li className="mb-6">
              ...
              <p>
                ...
                de paliar al máximo tanto las necesidades de los psicólogues,
                como aquellas provenientes de les usuaries. Así que, por ello,
                ¡te invitamos a{" "}
                <Link href="/contact">
